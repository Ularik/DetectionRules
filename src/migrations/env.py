...
from sqlalchemy.ext.asyncio import async_engine_from_config  # Асинхронный движок
from sqlalchemy import pool

from alembic import context  # noqa: F402
...
# Вспомогательная функция для выполнения миграций в асинхронном контексте
...
def run_migrations_online() -> None:
    ...
    """
    # Вместо создания синхронного подключения, запускаем асинхронный event loop
